        ...
        return (
            <>
                <div className="px-4 py-5 my-5 mt-0 text-center bg-info">
                    ...
                    <div className="col-lg-6 mx-auto">
                        <p className="lead mb-4">
                            The only resource you'll ever need to plan an run
                            your in-person or virtual conference for thousands
                            of attendees and presenters.
                        </p>
                ...
                <div className="container">
                    ...
                    <div className="row">
                        {this.state.conferenceColumns.map(
