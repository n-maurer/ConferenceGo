...
class PresentationForm extends React.Component {
    constructor(props) {
        ...
        this.handlePresenterNameChange =
            this.handlePresenterNameChange.bind(this);
    ...
    async componentDidMount() {
        ...
        if (response.ok) {
            ...
            // const otherDate = { ...this.state };

            // otherDate.presenter_name = otherDate.presenterName;
            // otherDate.company_name = otherDate.companyName;
            // otherDate.presenter_email = otherDate.presenterEmail;

            // delete otherDate.companyName;
            // delete otherDate.presenterName;
            // delete otherDate.presenterEmail;
            // delete otherDate.conferences;
